...
<div class="mt-6 rounded-xl border border-cyan-300/20 bg-slate-900/70 overflow-hidden">
            ...
            <tr class="hover:bg-slate-800/40">
                ...
                <td class="text-xs">
                    ...
                    @else
                        ...
                        <span
                            class="{{ $requisicao->data_devolucao_prevista && now()->gt($requisicao->data_devolucao_prevista) ? 'text-red-400 font-semibold' : '' }}"
